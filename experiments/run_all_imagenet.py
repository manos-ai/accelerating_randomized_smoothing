...
# -*- coding: utf-8 -*-
"""
eval RS for various sample sizes n and noise levels sigma on ImageNet, models of [Cohen et al., 2019]
"""
...
for sigma_str in tqdm.tqdm(sigmas_str):
    ...
    for n in ns:
        ...
        # save results
        fname = '../results/results_RS_ImageNet_nopred_{}_{}_sigma_{}_N_{}_alpha_{}_certbatch_{}_nclasses_{}_skip_{}.pkl'.format(dset, arch, sigma,
                                                                                                           num_samples_2, alpha, 
...
# pickle all results
with open('../results/pA_all_imagenet.pickle', 'wb') as handle:
    pickle.dump(pA_all, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open('../results/rA_all_imagenet.pickle', 'wb') as handle:
